...
int preventOverflow(char** pBuffer, char** pBufferParcours, char* s); // Vérifie que la concaténation de s à buffer ne fera pas dépasser son espace mémoire reservé, réallout buffer sinon